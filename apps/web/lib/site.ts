...
export const siteConfig = {
  ...
  publicSections: [
    ...
    { href: '/commune/services', label: 'Services' },
    { href: '/commune/actualites', label: 'Actualites' },
    { href: '/commune/agenda', label: 'Agenda' },
    { href: '/commune/documents', label: 'Documents' },
    { href: '/commune/contact', label: 'Contact' },
    { href: '/commune/faq', label: 'FAQ' },
    { href: '/commune/demarches', label: 'Demarches' },
    { href: '/commune/signalement', label: 'Signalement' },
    { href: '/auth/login', label: 'Connexion / Inscription' },
  ],
  citizenSections: [
    { href: '/commune/espace-citoyen', label: 'Tableau de bord' },
    { href: '/commune/profil', label: 'Profil' },
    { href: '/commune/notifications', label: 'Notifications' },
    { href: '/commune/messages', label: 'Messages' },
  ],
  trustSections: [
    { href: '/commune/transparence', label: 'Transparence' },
    { href: '/commune/confidentialite', label: 'Confidentialite' },
    { href: '/commune/mentions-legales', label: 'Mentions' },
  ],
  backofficeSections: [
